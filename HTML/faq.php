...
<head>
    ...
    <link rel="stylesheet" href="../CSS/estilofqa.css">
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="faq.php">FQA</a></li>
    ...
    <main id="princ" class="fqa">
        <!--Conteúdo principal do site-->
        <div class="row justify-content-center">
            <div class="col-12 mb-3"><hr></div>
            <div class="col-sm-4">
                <h4 class="text-center">Visite Nossas Redes Sociais</h4>
                <div class="btn-group-vertical btn-block w-100" role="group">
                    <a href="#" class="btn btn-outline-primary">Facebook</a>
                    <a href="#" class="btn btn-outline-info">Instagram</a>
                    <a href="#" class="btn btn-outline-warning">Twitter</a>
                </div>
            </div>
        </div>
    </main>
